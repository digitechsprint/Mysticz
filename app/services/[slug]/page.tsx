    ...
    <>
      <Section className="!pb-0 sm:!pb-0 lg:!pb-0">
        <div className="grid items-center gap-9 lg:grid-cols-2 lg:gap-[72px]">
          <Reveal>
            ...
            <h1 className="m-0 mb-[22px] max-w-[20ch] font-display text-[clamp(38px,5vw,68px)] font-semibold leading-[1.07] tracking-[-0.015em] text-ink text-pretty">
              {service.heroHeading}
            </h1>
      ...
      <Section ground="band" topRule className="!mt-8 lg:!mt-10">
        <div className="grid gap-9 lg:grid-cols-2 lg:gap-[72px]">
          <Reveal>
            ...
            <h2 className="m-0 mb-5 font-display text-[clamp(28px,3.6vw,46px)] font-semibold leading-[1.12] text-ink text-pretty">
      ...
      <Section ground="band" topRule>
        <div className="flex flex-wrap items-center justify-between gap-8">
          <h2 className="m-0 max-w-[24ch] font-display text-[clamp(28px,3.6vw,46px)] font-semibold leading-[1.12] text-ink text-pretty">
            {service.closing}
          </h2>
