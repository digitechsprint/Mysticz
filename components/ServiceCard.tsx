  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col px-7 pb-8 pt-7">
        ...
        <h3 className="m-0 mb-3.5 font-display text-[27px] font-semibold leading-tight text-ink">{service.title}</h3>
        ...
        <span className="mt-auto inline-flex items-center gap-2.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-olive">
